// Bundles the Azure Functions v4 Node entry into index.js. The
...
await build({
  entryPoints: [join(app, "index.ts")],
  outfile: join(app, "index.js"),
  bundle: true,
  platform: "node",
  target: "node22",
  format: "cjs",
...
// again.
//
// const dataSrc = join(app, 'node_modules/geoip-country/data')
// const dataDst = join(app, 'data')
